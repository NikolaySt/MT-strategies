...
#include <SAN_Systems\Signal\N002\N002_Header.mqh>//signal
...
{ 
   if (IsTesting()){              
      ...
      Stat_HistOrdersToDll_Params(
         ...
         "N002_MACross_BackBar="+N002_MACross_BackBar+";"+
         "N002_FastPeriod="+N002_FastPeriod+";"+
         "N002_SlowPeriod="+N002_SlowPeriod+";"+
         "N002_MABreakPeriod="+N002_MABreakPeriod+";"+
         "N002_Bars_Break="+N002_Bars_Break+";"
         );    
