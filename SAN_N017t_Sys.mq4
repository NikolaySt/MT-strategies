...
#include <SAN_Systems\Signal\N017\N017_Header.mqh>
...
#include <SAN_Systems\Signal\A001\A001_HeaderVars.mqh>//signal
...
int init(){     
   N017_Signal_Trace = false;
   Orders_Trace = false;
   settIDCurrent = 0;
        
   Common_InitAll(settIDCurrent);
   N017_Signals_Init(settIDCurrent);
   return(0);
}
...
int start()
{
   ...
   N017_Signals_Process(settIDCurrent);
   return(0);
}
