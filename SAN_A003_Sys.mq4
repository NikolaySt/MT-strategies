...
#include <SAN_Systems\Signal\A003\A003_Header.mqh>//Signal
...
int start()
{
   ...
   if(SignalBaseName != "A003")
   {
      Print("SignalBaseName != A003 error!!!!!!! SignalBaseName=", SignalBaseName);
      return (1);
   }
   ...
   /*
   //Print("Before Common_Process...");
   Common_Process(0);
   //Print("Before A003_Signals_Process...");
   A003_Signals_Process(0);
   //Print("After A003_Signals_Process...");
   //*/
   return(0);
}
