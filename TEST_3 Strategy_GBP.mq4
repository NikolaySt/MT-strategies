...
double LotsSys3=0.1;
double TradeMMSys3=0;             
double LossFactorSys3=2;
int    MMStartSys3=0;         
int    MMResetSys3=2;       
...
extern int       ATRPeriod3          = 80;         
extern double    ATRTrailingFactor3  = 13;         
extern int       BOL_period          = 7;
extern int       PrevBreak           = 1; 
extern int       BolRangeMin         = 40;
...
int deinit(){ 
   if (IsTesting()){         
      if (!IsOptimization()){
         HistoryClosePositionToFile(false, 1000, "history_"+SignalBaseName+".txt");
         DropDownToFile(false, 1000, "dropdown_"+SignalBaseName+".txt");
         AverageAnnualReturn(1000);
         SumMonthlyProfitToFile("monthly_profit_"+SignalBaseName+".txt");
         MOSystem(true);                          
      }                      
...
{  
   ...
   double atrStops=iATR(NULL,5,ATRPeriod3,1);
...
////////////////////////////////////////////////////////////////////////////
   ...
   */
	...
	if (orderOp >= 0){
	   double TrueLotsSys3 = LotsSys3;//M001_MM_Get(0);
