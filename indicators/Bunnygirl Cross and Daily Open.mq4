   ...
   int timeframe = Period();
	if (Period() == timeframe)
	{
		...
		for (i = indexbegin-counted_bars; i >= 0; i--)
		{
			...
			ma20c = iMA(NULL, timeframe, 20, 0, ma_method, PRICE_CLOSE, i);
			ma20p1 = iMA(NULL, timeframe, 20, 0, ma_method, PRICE_CLOSE, i+1);
			ma20p2 = iMA(NULL, timeframe, 20, 0, ma_method, PRICE_CLOSE, i+2);
			diff0 = iMA(NULL, timeframe, 5, 0, ma_method, PRICE_CLOSE, i) - ma20c;
			diff1 = iMA(NULL, timeframe, 5, 0, ma_method, PRICE_CLOSE, i+1) - ma20p1;
			diff2 = iMA(NULL, timeframe, 5, 0, ma_method, PRICE_CLOSE, i+2) - ma20p2;
