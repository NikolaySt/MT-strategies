...
extern bool ActiveVisulTest = false;
//extern---------------------
 extern bool useGlennsTimes = FALSE;
 extern bool LOCisOldest = FALSE;
 extern bool enableLargeLines = TRUE;
 extern bool addLOCText = FALSE;
 extern bool elementLabels = TRUE;
 extern bool addPriceTags = TRUE;
 extern color colorBars = White;
 extern int widthBars = 2;
 extern int WindowHeight = 400;
 extern bool useEndTime = FALSE;
 extern datetime endtime = D'01.01.2009 02:00';
 extern color colorTime = Brown;
 extern color colorPrice = Purple;
 extern color colorBias = Blue;
 extern color colorChannel = White;
//extern---------------------
...
int start() {
   ...
   if (TimeCurrent() > gi_360) {
      ...
      if (l_ind_counted_8 == 0) {
         ...
         if (gi_156 || 0)
            if (gi_296 == 0) for (int li_20 = iBars(Symbol(), g_timeframe_160) - 1 - gi_280; li_20 >= iBarShift(Symbol(), g_timeframe_160, endtime); li_20--) addLargeBar(li_20);
         if (gi_284 == 0) {
      ...
      if (gi_156) {
         ...
         g_count_180++;
         l_name_24 = "LineA" + g_count_180;
         if (!ObjectCreate(l_name_24, OBJ_TREND, 0, l_datetime_164, l_price_168, Time[0], l_price_168)) Print("error: can\'t create text_object! code #", GetLastError() + l_name_24);
         ObjectSet(l_name_24, OBJPROP_STYLE, STYLE_DASH);
         ObjectSet(l_name_24, OBJPROP_RAY, TRUE);
         ObjectSet(l_name_24, OBJPROP_WIDTH, 1);
      ...
      ObjectSetText(g_name_308, "o=" + DoubleToStr(TS2k_GetElement(gs_140, 6, 50, -1), 0) + ";f=" + DoubleToStr(TS2k_GetElement(gs_140, 6, 51, -1), 0) + ";t=" + DoubleToStr(TS2k_GetElement(gs_140, 3, 6, -1), 0) +
         ";p=" + DoubleToStr(TS2k_GetElement(gs_140, 4, 6, -1), 0) + "; b=" + DoubleToStr(TS2k_GetElement(gs_140, 5, 6, -1), 0) + ";O=" + DoubleToStr(TS2k_GetElement(gs_148, 6, 50, -1), 0) + ";F=" + DoubleToStr(TS2k_GetElement(gs_148, 6, 51, -1), 0) + ";T=" + DoubleToStr(TS2k_GetElement(gs_148, 3, 6, -1), 0) + ";P=" + DoubleToStr(TS2k_GetElement(gs_148, 4, 6, -1), 0) + "; B=" + DoubleToStr(TS2k_GetElement(gs_148, 5, 6, -1), 0) + ";", 10, "Arial", LightGray);
      ...
      if (li_144 == 5 && li_264 < 0) l_text_280 = "bias";      
      ObjectSetText(g_name_316, "small LOC = " + l_text_280, 10, "Arial", l_color_276);

      if (li_268) l_text_280 = "EXIT.MODE";
      if (li_272) l_text_280 = "ENTRY.MODE";
      if (li_144 == 3) l_text_280 = l_text_280 + " / " + "VOLATILE";
      if (li_144 == 4) l_text_280 = l_text_280 + " / " + "Organized TREND";
      if (li_144 == 5 && li_264 > 0) l_text_280 = l_text_280 + " / " + "ACCUMULATION";
      if (li_144 == 5 && li_264 < 0) l_text_280 = l_text_280 + " / " + "DISTRIBUTION";
