...
int start(){
   ...
   text = text + "EURUSD" + 
      "\n" + "МО = "+ DoubleToStr(Clac_PMO(true, false, "EURUSD"), 2) +  
      "\n" + "Коеф. RR =  " + RR_string_value +
      "\n" + "Познаваемост = " + Cognoscibility_string_value + "%" +
      "\n" + "______________________" + "\n";
  
   text = text + "GBPUSD" + 
      "\n" + "МО = "+ DoubleToStr(Clac_PMO(true, false, "GBPUSD"), 2) +  
      "\n" + "Коеф. RR =  " + RR_string_value +
      "\n" + "Познаваемост = " + Cognoscibility_string_value + "%" +
      "\n" + "______________________" + "\n";
      
   text = text + "AUDUSD" + 
      "\n" + "МО = "+ DoubleToStr(Clac_PMO(true, false, "AUDUSD"), 2) +  
      "\n" + "Коеф. RR =  " + RR_string_value +
      "\n" + "Познаваемост = " + Cognoscibility_string_value + "%" +
      "\n" + "______________________" + "\n";      
        
   text = text + "USDCAD" + 
      "\n" + "МО = "+ DoubleToStr(Clac_PMO(true, false, "USDCAD"), 2) +  
      "\n" + "Коеф. RR =  " + RR_string_value +
      "\n" + "Познаваемост = " + Cognoscibility_string_value + "%" +
      "\n" + "______________________" + "\n";  
         
   text = text + "USDJPY" + 
      "\n" + "МО = "+ DoubleToStr(Clac_PMO(true, false, "USDJPY"), 2) +  
      "\n" + "Коеф. RR =  " + RR_string_value +
      "\n" + "Познаваемост = " + Cognoscibility_string_value + "%" +
      "\n" + "______________________" + "\n";  
