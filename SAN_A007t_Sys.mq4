...
#include <SAN_Systems\Signal\A007\A007_Header.mqh>
...
int start()
{
   ...
   if(SignalBaseName != "A007")
   {
      Print("SignalBaseName != A007 error!!!!!!! SignalBaseName=", SignalBaseName);
      return (1);
   }
