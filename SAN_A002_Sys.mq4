...
#include <SAN_Systems\Signal\A002\A002_Header.mqh>//signal
...
int start()
{
   ...
   if(SignalBaseName != "A002")
   {
      Print("SignalBaseName != A002 error!!!!!!! SignalBaseName=", SignalBaseName);
      return (1);
   }
   
   if( TrendBaseName != "TA001" && A002_TrendOptions > 0 )
   {
      Print("TrendBaseName != TA001 error !!!!!!! signala raboti samo s trend A002 ne sys ",TrendBaseName );
      return (1);
   }
