...
{ 
   if (IsTesting()){         
      ...
      Stat_HistOrdersToDll_Params(
         ...
         "N003_FastPeriod="+N003_FastPeriod+";"+
         "N003_SlowPeriod="+N003_SlowPeriod+";"+
         "N003_BarsCross_BackBar="+N003_BarsCross_BackBar+";"+
         "N003_Bars_Break="+N003_Bars_Break+";"+
         "N003_MAPeriod="+N003_MAPeriod+";"
         );    
   }              
   return(0);
}
